"""
    Logging class.
    This class implementation provides logging facilities.
"""
import interface3
import protocol3
import time
...
class Logging():
    ...
    """
    def __init__(self):
        self.protocol = protocol3.Protocol()
...
def test1():
    ...
    class MyServer():
        def __init__(self, name, port):
            self.name = name
            self.proto = protocol3.Protocol(zmq.ROUTER, ["MYPROTO"])
    ...
    class MyClient():
        def __init__(self, name, port):
            self.name = name
            self.proto = protocol3.Protocol(zmq.REQ, ["MYPROTO"])
